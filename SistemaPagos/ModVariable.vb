Module ModVariable
    ...
    Public cnStr = "Provider=SQLOLEDB.1;Persist Security Info=False;User ID=sa;Initial Catalog=bd_postgrado;Data Source=DESKTOP-JPQOK8S"
