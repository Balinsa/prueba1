...
Imports MSFlexGridLib.MergeCellsSettings
    ...
    Public Sub MuestraSedes_cbo(cboSede As ComboBox)
        ...
        With rssql
            ...
            While Not .EOF
                ...
                cboSede.Items.Add(Trim(CStr(.Fields(0).Value)))
                .MoveNext()
            End While
        End With
    End Sub
...
PROC_ERR:  'MsgBox err.Description
    ...
    Public Sub Muestra_Menciones(DatCProgramas As ComboBox, Optional intOpcion As Integer = 1)
        ...
        Try
            ...
            DatCProgramas.DisplayMember = "NOMPROGRAMA" ' (dónde Nombre2 es el campo del datatable que quiero que se muestre al usuario)
            DatCProgramas.ValueMember = "CODPROGRAMA"
            DatCProgramas.DataSource = objDT
            DatCProgramas.SelectedIndex = 0
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
        ...
        ' rs is the ADODB.Recordset





        'MsgBox(rssql.Fields(0).Value)

        'Dim dt As New DataTable
        'dt = RecordSetToDataTable(rssql)

       

        'DatCProgramas.Items.Add("GOL")

        'ComboBox1.DisplayMember = "Nombre2" ' (dónde Nombre2 es el campo del datatable que quiero que se muestre al usuario)
...
errores_:  'MsgBox err.Description
    ...
    '** consulta el valor del contador en la tabla parametro, para conocer
    '** el siguiente correlativo y generar un codigo
    Public Sub Asigna_msh(CodMencion As String, NUMPLAN As String, mshPlan As MSFlexGrid)
    ...
    CodMencion As String, mshPlan As MSFlexGrid)
...
errores:
    ...
    '** en un datacombo
    Public Sub MuestraNumPlanes(CodMencion As String, DatCNumPlan As ComboBox)
        On Error GoTo errores_
        Ssql = "Select * From vista_NumPlanMencion Where CODMENCION='" & CodMencion & "'"
        Ejecuta_consultas(Ssql, rssql)
        'If rssql.EOF Or rssql.BOF Then Exit Sub
        DatCNumPlan.DisplayMember = "NUMPLAN"
        DatCNumPlan.DataSource = rssql
        DatCNumPlan.Focus()
errores_:
    End Sub
    ...
    Public Sub MuestraSedes(DatcSede As ComboBox)
        Ssql = "Select * From SEDE Order By 1"
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Sub
        'DatcSede.RowSource = rssql
        DatcSede.DataSource = rssql
    ...
    CodMencion As String, SEDE As String)
        ...
        With cmd
            ...
            .ActiveConnection = cn ' cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("SEDE", adVarChar, adParamInput, 30, SEDE)
            .CreateParameter("PROMOCION", adChar, adParamInput, 6, PROMOCION)
            rssql = .Execute
            I = .Parameters("RETURN_VALUE").Value  '
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    ...
    Optional NOTA As Double = 12) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("PROMOCION", adChar, adParamInput, 6, PROMOCION)
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("SEMESTRE", adChar, adParamInput, 6, SEMESTRE)
            .CreateParameter("TCRED", adTinyInt, adParamInput, , TCRED)
            .CreateParameter("NOTA", adDouble, adParamInput, , NOTA)
            Mostrar_AlumnosInvictos = .Execute
            I = .Parameters("RETURN_VALUE").Value  'filas afectadas
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
...
PROC_ERR:  'MsgBox Err.Description
    ...
    Public Function TraeCicloAlumno(CODALUMNO As String) As String
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
            rssql = .Execute
            I = .Parameters("RETURN_VALUE").Value '
            TraeCicloAlumno = IIf(Trim(rssql.Fields(1).Value) = 0, 1, IIf(rssql.Fields(1).Value > 4, 4, Trim(rssql.Fields(1).Value)))
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
    ...
    Public Function AlumnosIngPorLetra(Letra As String, CodMencion As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("Letra", adVarChar, adParamInput, 20, Letra)
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    SEMESTRE As String, Optional ind As Integer = 1) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("SEMESTRE", adChar, adParamInput, 6, SEMESTRE)
            .CreateParameter("Ind", adTinyInt, adParamInput, , ind)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    CodMencion As String) As ADODB.Recordset ', SEDE As String
        ...
        With cmd
            ...
            .CreateParameter("Letra", adVarChar, adParamInput, 20, Letra)
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            ' .CreateParameter("SEDE", adChar, adParamInput, 30, SEDE)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    Public Function Alu_Sustentantes(TIPO As Integer, CODPROGRAMA As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("Tipo", adTinyInt, adParamInput, , TIPO)
            .CreateParameter("CODPROGRAMA", adVarChar, adParamInput, 5, CODPROGRAMA)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    CodMencion As String, ind As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("Letra", adVarChar, adParamInput, 20, Letra)
            .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
            .CreateParameter("CODMENCION", adVarChar, adParamInput, 40, CodMencion)
            .CreateParameter("Ind", adTinyInt, adParamInput, , ind)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    SEDE As String, CODCURSO As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("SEMESTRE", adChar, adParamInput, 6, SEMESTRE)
            .CreateParameter("SEDE", adVarChar, adParamInput, 30, SEDE)
            .CreateParameter("CODCURSO", adChar, adParamInput, 6, CODCURSO)
...
errores_:
    ...
    CODCURSO As String, SEDE As String, GRUPO As Integer, SECCION As TextBox)
        ...
        With cmd
            ...
            .CreateParameter("CODCURSO", adChar, adParamInput, 6, CODCURSO)
            .CreateParameter("SEDE", adVarChar, adParamInput, 30, SEDE)
            .CreateParameter("GRUPO", adVarChar, adParamInput, 2, GRUPO)
            .Execute(Options:=adExecuteNoRecords)
            I = .Parameters("RETURN_VALUE").Value 'la seccion
        End With
        cmd = Nothing
        SECCION.Text = String.Format(I, "00")
errores_:
    End Sub
...
errores_:
    ...
    CODCURSO As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("SEDE", adVarChar, adParamInput, 30, SEDE)
            .CreateParameter("SEMESTRE", adVarChar, adParamInput, 6, SEMESTRE)
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("GRUPO", adChar, adParamInput, 2, GRUPO)
            .CreateParameter("CODCURSO", adChar, adParamInput, 6, CODCURSO)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    CODCURSO As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("SEMESTRE", adVarChar, adParamInput, 6, SEMESTRE)
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("SECCION", adTinyInt, adParamInput, , SECCION)
            .CreateParameter("CODCURSO", adChar, adParamInput, 6, CODCURSO)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    SEMESTRE As String, NTCRED As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
            .CreateParameter("SEMESTRE", adVarChar, adParamInput, 6, SEMESTRE)
            .CreateParameter("NTCRED", adTinyInt, adParamOutput, , vbNull)
            TraerPromNumCredSemestral = .Execute
            NTCRED = .Parameters("NTCRED").Value
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function

    Public Sub MuestraSemestresNotas(DatCSemestre As ComboBox)
        Ssql = "Select Distinct SEMESTRE From NOTAS Order By 1"
        Ejecuta_consultas(Ssql, rssql)
        DatCSemestre.DisplayMember = "SEMESTRE"
        DatCSemestre.DataSource = rssql
        'DatCSemestre.ListField = "SEMESTRE"
        'DatCSemestre.RowSource = rssql
    End Sub

    Public Sub Trae_EspecProfesion(DatCEsp As ComboBox, DatCProf As ComboBox)
        Ssql = "Select * From PROFESIONES Order By 1"
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Sub
        DatCEsp.DataSource = rssql
        DatCProf.DataSource = rssql
    ...
    Sexo As String, ind As Integer, NUMPLAN As String) As Integer
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("CODIGO", adVarChar, adParamInput, 10, CODIGO)
            .CreateParameter("NOMBRE", adVarChar, adParamInput, 80, NOMBRE)
            .CreateParameter("DIRECCION", adVarChar, adParamInput, 80, DIRECCION)
            .CreateParameter("TELEFONO", adVarChar, adParamInput, 14, TELEFONO)
            .CreateParameter("EMAIL", adVarChar, adParamInput, 80, EMAIL)
            .CreateParameter("CENTROTRABAJO", adVarChar, adParamInput, 80, CENTROTRABAJO)
            .CreateParameter("PROFESION", adVarChar, adParamInput, 80, PROFESION)
            .CreateParameter("ESPECIALIDAD", adVarChar, adParamInput, 80, ESPECIALIDAD)
            .CreateParameter("SEXO", adVarChar, adParamInput, 1, Sexo)
            .CreateParameter("NUMPROMO", adTinyInt, adParamInput, , NUMPROMO)
            .CreateParameter("IND", adTinyInt, adParamInput, , ind)
            .CreateParameter("NUMPLAN", adVarChar, adParamInput, 5, NUMPLAN)
            .Execute(Options:=adExecuteNoRecords)
            ActualizaAlumnoProf = .Parameters("RETURN_VALUE").Value '
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox err.Description
    End Function
...
errores_:
    ...
    SEMESTRE As String, CODCURSO As String) As Integer
        ...
        With cmd
            ...
            .CreateParameter("SEMESTRE", adChar, adParamInput, 6, SEMESTRE)
            .Execute(Options:=adExecuteNoRecords)
            YaEstaInscritoEnCurso = .Parameters("RETURN_VALUE").Value '1 o 0
        End With
        cmd = Nothing
errores_:
    End Function
    ...
    NUMPLAN As String) As Integer
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        If Trim(rssql.Fields(0).Value) = "" Then Exit Function

        Requisitos(0, 0) = Trim(rssql.Fields(0).Value)
        intNReq = intNReq + 1 ' un requisito

        If Trim(rssql.Fields(1).Value) <> "" Then Exit Function
        Requisitos(0, 1) = Trim(rssql.Fields(1).Value) 'dos requisitos
        intNReq = intNReq + 1
    End Function
    ...
    CODALUMNO As String, Optional NumReqCurso As Integer = 1) As Integer
        ...
        With cmd
            ...
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("CODCURSO", adChar, adParamInput, 6, CODCURSO)
            .CreateParameter("NUMPLAN", adChar, adParamInput, 5, NUMPLAN)
            .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
            .CreateParameter("NumReqCurso", adTinyInt, adParamInput, , NumReqCurso)
            .Execute(Options:=adExecuteNoRecords)
            CumpleRequisitoCurso = .Parameters("RETURN_VALUE").Value '> 0 si cumple Requisitos
        End With
        cmd = Nothing
errores_:
    End Function
    ...
    SEMESTRE As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("MENCION", adChar, adParamInput, 4, MENCION)
            .CreateParameter("SEMESTRE", adChar, adParamInput, 6, SEMESTRE)
...
errores_:
    ...
    Optional Ret_Cons As Integer = 0) As Integer
        ...
        With cmd
            ...
            Else : rssql = .Execute
            End If
            ExisteProgramacion = .Parameters("RETURN_VALUE").Value
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
    ...
    Public Function SemestresAcad(ESTADOACTUAL As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("ESTADOACTUAL", adChar, adParamInput, 2, ESTADOACTUAL)
...
PROC_ERR:  'MsgBox err.Description
    ...
    Public Function PromedioSemestralAcu(CODALUMNO As String, SEMESTRE As String) As Double
        ...
        With cmd
            ...
            .CreateParameter("SEMESTRE", adChar, adParamInput, 6, SEMESTRE)
            rssql = .Execute
            PromedioSemestralAcu = rssql.Fields(1).Value
        End With
        cmd = Nothing
PROC_ERR:  ' MsgBox err.Description
    End Function
    ...
    Public Function PromedioSemAcuCursoMay(CODALUMNO As String) As Double
        ...
        With cmd
            ...
            .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
            rssql = .Execute
            PromedioSemAcuCursoMay = rssql.Fields(1).Value
        End With
        cmd = Nothing
PROC_ERR:  ' MsgBox err.Description
    End Function
...
PROC_ERR:  'MsgBox Err.Description
    ...
    Public Sub Traersemestres(CodMencion As String, DatCSemestre As ComboBox)
        On Error GoTo errores_
        Ssql = "Select Distinct PROMOCION From ALUMNO WHERE CODMENCION='" & CodMencion & "' AND ESTADOACTUAL<>'01' ORDER BY 1"
        Ejecuta_consultas(Ssql, rssql)
        DatCSemestre.ValueMember = "PROMOCION"
        DatCSemestre.DataSource = rssql
...
errores_:  'MsgBox err.Description
    ...
    Public Function TraeAbrevPrograma(CODPROGRAMA As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        TraeAbrevPrograma = Trim(rssql.Fields(0).Value)
    End Function
    ...
    Public Function TraeSeccPrograma(CODPROGRAMA As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        TraeSeccPrograma = Trim(rssql.Fields(0).Value)
    End Function
    ...
    Public Function TraeGradoAcadMag(CodMencion As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        TraeGradoAcadMag = Trim(rssql.Fields(0).Value)
    End Function
    ...
    Public Function TraeProfAlumno(CODALUMNO As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        TraeProfAlumno = Trim(rssql.Fields(0).Value)
    End Function
    ...
    LetraCodigo As String, Optional ind As Integer = 0) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("CODPROGRAMA ", adChar, adParamInput, 5, CODPROGRAMA)
            .CreateParameter("LetraCodigo", adVarChar, adParamInput, 10, LetraCodigo)
            .CreateParameter("Ind", adTinyInt, adParamInput, , ind)
...
errores_:  'MsgBox err.Description
    ...
    Public Function BUSCACURSO(cod As String, CODPROG As String, SEMES As String, SEDE As String, ind As Integer) As ADODB.Recordset
        'cn.BeginTrans
        BUSCACURSO = cn.Execute("exec SPBUSCACURSO '" & cod & "','" & CODPROG & "','" & SEMES & "','" & SEDE & "'," & ind & "")
        'MsgBox err.Description
    End Function
...
errores_:
    ...
    Public Function NCreditosPlanSegunOE(NUMPLAN As String, CONDCURSO As String) As Integer
        ...
        With cmd
            ...
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("NUMPLAN ", adChar, adParamInput, 5, NUMPLAN)
            .CreateParameter("CONDCURSO", adVarChar, adParamInput, 2, CONDCURSO)
            .Execute(Options:=adExecuteNoRecords)
            NCreditosPlanSegunOE = .Parameters("RETURN_VALUE").Value
        End With
        cmd = Nothing
errores_:  'MsgBox Err.Description
    End Function
    ...
    PROMOCION As String, ind As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("CODMENCION ", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("SEDE", adVarChar, adParamInput, 10, SEDE)
            .CreateParameter("PROMOCION", adChar, adParamInput, 6, PROMOCION)
            .CreateParameter("Ind ", adTinyInt, adParamInput, , ind)
...
errores_:  'MsgBox Err.Description
    ...
    ESTADO As String) As Integer
        ...
        With cmd
            ...
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
            .CreateParameter("SEMES", adChar, adParamInput, 6, SEMESTRE)
            .CreateParameter("ESTADO", adChar, adParamInput, 2, ESTADO)
            .Execute(Options:=adExecuteNoRecords)
            EliminaMatricula = .Parameters("RETURN_VALUE").Value '0 ok
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
    ...
    Public Function EliminaMatriculaVerano(CODALUMNO As String, ESTADO As String, SEMESTRE As String) As Integer
        ...
        With cmd
            ...
            .CreateParameter("SEMES", adChar, adParamInput, 6, SEMESTRE)
            .Execute(Options:=adExecuteNoRecords)
            EliminaMatriculaVerano = .Parameters("RETURN_VALUE").Value '0 ok
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
    ...
    Public Function TraerMaxPlanMencion(CodMencion As String) As ADODB.Recordset
...
errores_:
    ...
    Public Function TraeEstadoAlumno(CODALUMNO As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        TraeEstadoAlumno = Trim(rssql.Fields(0).Value)
    End Function
    ...
    Public Sub ActualizarCiclo(CODALUMNO As String)
        ...
        While Not rs.EOF
            sem = Trim(rs.Fields(1).Value) 'semestre
            cmd = New ADODB.Command
            With cmd
                ...
                .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
                .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
                .CreateParameter("SEMESTRE", adChar, adParamInput, 6, sem)
                .CreateParameter("CICLO", adChar, adParamInput, 1, CIC)
                .Execute(Options:=adExecuteNoRecords)
                Ret = .Parameters("RETURN_VALUE").Value '> 0 OOk
            End With
            cmd = Nothing
            CIC = CIC + 1
            rs.MoveNext()
...
PROC_ERR:  'MsgBox Err.Description
    ...
    Public Function NumCursosLlevados(CODALUMNO As String, NUMPLAN As String) As Integer
        ...
        With cmd
            ...
            NumCursosLlevados = .Parameters("RETURN_VALUE").Value '
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
...
errores_:  ' MsgBox err.Description
    ...
    CodMencion As String, AnyoINGRESO As String) As String
        ...
        While Not rssql.EOF
            If rssql.Fields("CODALUMNO").Value = CODALUMNO Then
                Coloca_OrdenMerito = String.Format(CStr(MERITO), "00")
                Exit Function
            End If
            MERITO = MERITO + 1
            rssql.MoveNext()
...
errores_:
    ...
    Public Function CursosCertificado(CODALUMNO As String, NUMPLAN As String, NOTA As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("CODALUMNO", adVarChar, adParamInput, 10, CODALUMNO)
            .CreateParameter("NUMPLAN", adChar, adParamInput, 5, NUMPLAN)
            .CreateParameter("NOTA", adTinyInt, adParamInput, , NOTA)
...
errores_:  'MsgBox Err.Description
    ...
    PROMOCION As String, Optional SEDE As String = "PIURA") As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("PROMOCION", adChar, adParamInput, 6, PROMOCION)
            .CreateParameter("SEDE", adVarChar, adParamInput, 20, SEDE)
...
errores_:  'MsgBox Err.Description
    ...
    PROMOCION As String, CREDPLAN As Integer, NOTA As Double, Optional SEDE As String = "PIURA") As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("PROMOCION", adChar, adParamInput, 6, PROMOCION)
            .CreateParameter("SEDE", adChar, adParamInput, 15, SEDE)
            .CreateParameter("CREDPLAN", adInteger, adParamInput, , CREDPLAN)
            .CreateParameter("NOTA", adDouble, adParamInput, , NOTA)
...
errores_:  'MsgBox err.Description
    ...
    Public Function OrdenMerito(SEMESTRE As String, CODALUMNO As String) As String
        ...
        Ssql = "Select MERITO from MERITO WHERE CODALUMNO ='" & CODALUMNO & _
                "' AND SEMESTRE ='" & SEMESTRE & "'"
        Ejecuta_consultas(Ssql, rssql)
        OrdenMerito = String.Format(rssql.Fields(0).Value, "00")
    ...
    SEMVALIDO As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("PROMOCION", adChar, adParamInput, 6, PROMOCION)
            .CreateParameter("SEMVALIDO", adChar, adParamInput, 6, SEMVALIDO)     '
...
PROC_ERR:  'MsgBox err.Description
    ...
    Public Sub ActualizarOrdenMerito(SEMESTRE As String)
        ...
        On Error Resume Next
        While Not rssql.EOF
            NOTA = rssql.Fields("PPS").Value
            While (NOTA = rssql.Fields("PPS").Value) And (Not rssql.EOF)
...
errores_:  'MsgBox err.Description
    ...
    ANYO As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("Tipo", adTinyInt, adParamInput, , TIPO)
            .CreateParameter("Anyo", adInteger, adParamInput, , ANYO)
...
errores_:  'MsgBox err.Description
    ...
    ind As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            .CommandType = adCmdStoredProc
            .ActiveConnection = cn
            .CreateParameter("Letra", adVarChar, adParamInput, 15, Letra)
            .CreateParameter("Ind", adTinyInt, adParamInput, , ind)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    nivel As String) As Integer
        ...
        Try
            ...
            With cmd
                ...
                LeeUser = .Parameters("@RETURN_VALUE").Value  '
                rssql = .Execute()
                'LeeUser = .Parameters("@RETURN_VALUE").Value  '
                If rssql.EOF Or rssql.BOF Then Exit Function
    ...
    Public Function ActualizaAnyo(DenAnyo As String) As Integer
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("DenAnyo", adVarChar, adParamInput, 250, DenAnyo)
            .Execute(Options:=adExecuteNoRecords)
            ActualizaAnyo = .Parameters("RETURN_VALUE").Value '
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox err.Description
    End Function
    ...
    Public Function Update_User(PASSWORD As String, USUARIO As String) As Integer
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("PASSWORD", adVarChar, adParamInput, 60, PASSWORD)
            .CreateParameter("USUARIO", adVarChar, adParamInput, 20, USUARIO)
            Update_User = .Parameters("RETURN_VALUE").Value '
            .Execute(Options:=adExecuteNoRecords)
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox err.Description
    ...
    Public Function Existen_UsuariosBD() As Integer
        ...
        With cmd
            ...
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .Execute(Options:=adExecuteNoRecords)
            Existen_UsuariosBD = .Parameters("RETURN_VALUE").Value '
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox err.Description
    End Function
...
PROC_ERR:  'MsgBox Err.Description
    ...
    Public Function TraeNombreAlumno(CODALUMNO As String)
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        TraeNombreAlumno = Trim(rssql.Fields(0).Value)
errores_:
    End Function
    ...
    CodMencion As String, NOTA As Double, TotalcredPlan As Integer, Optional TIPO As Integer = 1, Optional SEDE As String = "PIURA") As ADODB.Recordset
        ...
        With cmd
            ...
            .CreateParameter("SEDE", adVarChar, adParamInput, 20, SEDE)
            .CreateParameter("NOTA", adDouble, adParamInput, , NOTA)
            .CreateParameter("TotalCredPlan", adTinyInt, adParamInput, , TotalcredPlan)
            .CreateParameter("Tipo", adTinyInt, adParamInput, , TIPO)
            AlumnosEgresados = .Execute
            k = .Parameters("RETURN_VALUE").Value 'n de alumnos de la consulta
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
...
PROC_ERR:  'MsgBox Err.Description
    ...
    Public Function TraeNotaAprobRegl() As Double
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        TraeNotaAprobRegl = IIf(Trim(rssql.Fields(0).Value) = 0, 12, Trim(rssql.Fields(0).Value))
errores_:  'MsgBox err.Description
    End Function
    ...
    PROMOCION As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        PlanEstudioPromocion = IIf(Trim(rssql.Fields(0).Value) = "", "2001-1", Trim(rssql.Fields(0).Value))
errores_:
    End Function
    ...
    Public Function MaxSemEvaluadoAlu(CODALUMNO As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        MaxSemEvaluadoAlu = IIf(Trim(rssql.Fields(0).Value) = "", "", Trim(rssql.Fields(0).Value))
errores_:
    End Function
    ...
    Public Function Trae_DescripcionAula(AULA As String) As String
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Function
        Trae_DescripcionAula = Trim(rssql.Fields(0).Value)
errores_:
    End Function
    ...
    Public Sub ObtieneDatosAlumno(PROMOCION As String, NUMPLAN As String, CODALUMNO As String)
        ...
        Ejecuta_consultas(Ssql, rssql)
        If rssql.EOF Or rssql.BOF Then Exit Sub
        PROMOCION = Trim(rssql.Fields(0).Value)
        NUMPLAN = Trim(rssql.Fields(1).Value)
errores_:
    End Sub
...
errores_:
    ...
    Public Function TraeNumeroCredHastaCiclo(CICLO As Integer, NUMPLAN As String) As Integer
        ...
        With cmd
            ...
            .CommandType = adCmdStoredProc
            .ActiveConnection = cn
            .CreateParameter("CICLO", adTinyInt, adParamInput, , CICLO)
            .CreateParameter("NUMPLAN", adChar, adParamInput, 5, NUMPLAN)
            rssql = .Execute
            TraeNumeroCredHastaCiclo = rssql.Fields(0).Value
        End With
        cmd = Nothing
PROC_ERR:  ' MsgBox err.Description
    End Function
    ...
    Public Function TraeSemestresEvaluadosProm(PROMOCION As String, CodMencion As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("PROMOCION", adTinyInt, adParamInput, 6, PROMOCION)
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    TipoCons As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("PROMOCION", adVarChar, adParamInput, 6, PROMOCION)
            .CreateParameter("NOTA", adDouble, adParamInput, , NOTA)
            .CreateParameter("TipoCons", adTinyInt, adParamInput, , TipoCons)
...
PROC_ERR:  'MsgBox err.Description
    ...
    Public Function Docentes_Tesis(Letra As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("Letra", adVarChar, adParamInput, 10, Letra)
...
PROC_ERR:  'MsgBox Err.Description
    ...
    SEMESTRE As String) As Integer
        ...
        With cmd
            ...
            .CreateParameter("SEMESTRE", adChar, adParamInput, 6, SEMESTRE)
            .Execute(Options:=adExecuteNoRecords)
            EliminaInsCurso = .Parameters("RETURN_VALUE").Value '0 es Ok
        End With
        cmd = Nothing
errores_:  'MsgBox err.Description
    End Function
    ...
    CodMencion As String) As ADODB.Recordset ', SEDE As String
        ...
        With cmd
            ...
            .CreateParameter("CODMENCION", adChar, adParamInput, 4, CodMencion)
            .CreateParameter("Letra", adVarChar, adParamInput, 20, Letra)
            .CreateParameter("NOTA", adDouble, adParamInput, , NOTA) 'NOTA as variable local
...
PROC_ERR:  'MsgBox Err.Description
    ...
    CodMencion As String, NOTA As Double, TotalcredPlan As Integer) As ADODB.Recordset
        ...
        With cmd
            ...
            I = .Parameters("RETURN_VALUE").Value 'n de alumnos de la consulta
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox Err.Description
    End Function
    ...
    CodMencion As String, NOTA As Double, TotalcredPlan As Integer, jj As Integer, Optional SEDE As String = "PIURA") As ADODB.Recordset
        ...
        With cmd
            ...
            jj = .Parameters("RETURN_VALUE").Value 'Nro de alumnos egresantes q han realizado convalidacion
        End With
        cmd = Nothing
PROC_ERR:  ' MsgBox err.Description
    End Function
    ...
    Public Function Resol_Coordinadores(intOpcion As Integer, CODPROGRAMA As String) As ADODB.Recordset
        ...
        With cmd
            ...
            .ActiveConnection = cn
            .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, 0)
            .CreateParameter("intOpcion", adTinyInt, adParamInput, , intOpcion)
            .CreateParameter("CODPROGRAMA", adVarChar, adParamInput, 5, CODPROGRAMA)
            Resol_Coordinadores = .Execute
            I = .Parameters("RETURN_VALUE").Value 'Nro de coord
        End With
        cmd = Nothing
PROC_ERR:  'MsgBox err.Description
    End Function
    ...
    Public Sub Muestra_Semestres(COD_MENCION As String, DatCSemestre As ComboBox)
        On Error Resume Next
    ...
    Public Sub MuestraSemestres_Notas(DatCSemestre As ComboBox, CodMencion As String)
        rssql = Busca("sp_SemestresEnInscripCursos", 4, "CODMENCION", CodMencion)
        DatCSemestre.ValueMember = "SEMESTRE"
        DatCSemestre.DataSource = rssql
